...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def open_file_argument(self, videoPath):
        path, _ = QFileDialog.getOpenFileName(self, "Open file", videoPath, "mp3 Audio (*.mp3);mp4 Video (*.mp4);Movie files (*.mov);All files (*.*)")
...
def executePlayer(videoPath):
    app = QApplication([])
    app.setApplicationName("CEL Multimedia Player")
    app.setStyle("Fusion")
    ...
    window = MainWindow()
    window.open_file_argument(videoPath)
    app.exec_()
